...
export default function CreateInvoice({ clients, articles, bundles = [], currentYear, nextSequence, invoice, isDuplicate }: CreateInvoiceProps) {
    ...
    const defaultItem: InvoiceItem = { article_id: '', bundle_id: '', description: '', code: '', quantity: 1, unit_price: 0, tax_rate: 18, discount: 0, additional_discount: 0, item_source: 'article' };
