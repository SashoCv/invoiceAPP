...
import type { Offer, Client, Article } from '@/types';
...
export default function EditOffer({ offer, clients, articles }: EditOfferProps) {
    const { t } = useTranslation();
    const [hasItems, setHasItems] = useState(offer.has_items);
