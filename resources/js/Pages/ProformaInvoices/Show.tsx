...
import { ArrowLeft, Pencil, Copy, FileText, Printer, ArrowRightLeft, Eye, Download, Send } from 'lucide-react';
...
export default function ShowProforma({ proforma }: ShowProformaProps) {
    ...
    const submitSend = () => {
        setSendLoading(true);
        router.post(`/proforma-invoices/${proforma.id}/send`, sendForm, {
            preserveScroll: true,
            onSuccess: () => {
