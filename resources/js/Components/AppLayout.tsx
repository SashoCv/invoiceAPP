    ...
    return (
        <>
            ...
            <div className="min-h-screen">
                ...
                <aside
                    className={cn(
                        'fixed inset-y-0 left-0 z-50 w-[240px] bg-white border-r border-gray-200 flex flex-col transition-transform duration-200 ease-out lg:translate-x-0',
                ...
                >
                    ...
                    <div className="h-12 flex items-center px-4 border-b border-gray-100">
                        <Link href="/dashboard">
                            <FynvoLogo size={26} className="text-blue-600" textClassName="text-gray-900 text-base" />
                        </Link>
                        <button
                            onClick={() => setSidebarOpen(false)}
                    ...
                    <nav className="flex-1 px-3 py-2 overflow-y-auto">
                        {navSections.map((section, sectionIndex) => (
                            <div key={sectionIndex} className={sectionIndex > 0 ? 'mt-2 pt-2 border-t border-gray-100' : ''}>
                                {section.label && (
                                    <p className="px-2 mb-0.5 text-[10px] font-semibold text-gray-400 uppercase tracking-wider">
                                        {section.label}
                                    </p>
                                )}
                        ...
                        */}
                        ...
                        {isAdmin && (
                            <div className="mt-2 pt-2 border-t border-gray-100">
                                <Link
                                    href="/admin"
                                    className="flex items-center gap-2 px-2 py-1.5 rounded-md text-xs font-medium transition-colors text-indigo-600 hover:bg-indigo-50"
                                    onClick={() => setSidebarOpen(false)}
                                >
                    ...
                    <div className="px-3 py-2 border-t border-gray-100">
                        ...
                        {/* User */}
                        <div className="flex items-center gap-2 p-1.5 -mx-1 rounded-md hover:bg-gray-50 transition-colors">
