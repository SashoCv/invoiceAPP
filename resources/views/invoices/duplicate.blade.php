<x-app-layout>
    <div x-data="invoiceForm()" x-init="init()">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">{{ __('invoices.duplicate_invoice') }}</h1>
                <p class="mt-1 text-sm text-gray-500">{{ __('invoices.duplicate_from') }}: {{ $invoice->formatted_number }}</p>
            </div>
        </div>
