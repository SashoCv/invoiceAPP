<x-app-layout>
    <div x-data="offerForm()" x-init="init()">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">{{ __('offers.create_offer') }}</h1>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="content" id="content" rows="6"
                                      ...
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm">{{ old('content') }}</textarea>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-4 py-2">
                                            <select x-model="item.article_id" @change="selectArticle(index)"
                                                ...
                                                <option value="">{{ __('offers.select_article') }}</option>
