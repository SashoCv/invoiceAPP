<x-app-layout>
    <div x-data="proformaForm()" x-init="init()">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">{{ __('proforma.duplicate_proforma') }}</h1>
                <p class="mt-1 text-sm text-gray-500">{{ __('proforma.duplicate_from') }}: {{ $proformaInvoice->formatted_number }}</p>
            </div>
        </div>
